...
export default class Echo extends IEcho {
  ...
  static warning = (message: any): void => {
    console.log(chalk.yellowBright(message.toString()));
  };

  static plain = (message: any): void => {
    console.log(chalk.whiteBright(message.toString()));
  };

  static header = (message: any): void => {
    console.log(chalk.blueBright(Figlet.textSync(message, { horizontalLayout: 'full' })));
  };
}
